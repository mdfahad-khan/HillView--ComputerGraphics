...
void ghostUpdate(int value)   //I013
{
    ...
    glutTimerFunc(200, ghostUpdate, 0); //Notify GLUT to call update again in 25 milliseconds
...
void show() //H000
{
    ...
    glColor3ub(0,0,0);
    text(250,250,"o Press 'Up Arrow' to nevigate to  Village");

    text(250,250-20,"o  Press 'Down Arrow' to nevigate to Hawor");
    text(250,250-40,"o  Press 'Left Arrow' to nevigate to City");

    text(250,250-60,"o  Press 'Right Arrow' to nevigate to Highway");

    text(250,250-80,"o  Press 'X' to stop and resume all cars");
    text(250,250-100,"o  Press 'F' to toggle full screen");
    glPopMatrix();
    glFlush();
    // Highway obj1;
    // obj1.showHighway();
